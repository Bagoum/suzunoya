...
public class _9DisturbanceScriptTest {
    ...
    private static readonly string[] stored = {
       ...
       // "<Reimu>.ComputedLocation ~ <0, 0, 0>",
        ...
        "<Reimu>.ComputedLocation ~ <0.125, 0.125, 0.125>",
        "<Reimu>.ComputedLocation ~ <0.125, 2.125, 0.125>",
        "<VNState>.$UpdateCount ~ 2",
        "<Reimu>.ComputedLocation ~ <0.25, 2.25, 0.25>",
        "<Reimu>.ComputedLocation ~ <0.25, 4.25, 0.25>",
        "<VNState>.$UpdateCount ~ 3",
        "<Reimu>.ComputedLocation ~ <0.375, 4.375, 0.375>",
        "<Reimu>.ComputedLocation ~ <0.375, 2.375, 0.375>",
        "<VNState>.$UpdateCount ~ 4",
        "<Reimu>.ComputedLocation ~ <0.5, 2.5, 0.5>",
        "<Reimu>.ComputedLocation ~ <0.5, 0.5, 0.5>",
        "<VNState>.$UpdateCount ~ 5",
        "<Reimu>.ComputedLocation ~ <0.625, 0.625, 0.625>",
        "<VNState>.$UpdateCount ~ 6",
        "<Reimu>.ComputedLocation ~ <0.75, 0.75, 0.75>",
        "<VNState>.$UpdateCount ~ 7",
        "<Reimu>.ComputedLocation ~ <0.875, 0.875, 0.875>",
