...
public class _3ExternalScriptRunExample {
    ...
    private static readonly string[] stored = {
	    ...
	    "<VNState>.CurrentOperationID ~ <color=red>hello wo<silent>rl</color>d</silent>",
	    ...
	    "<VNState>.CurrentOperationID ~ I can make multi-part dialogue like this,",
	    ...
	    "<VNState>.CurrentOperationID ~  or like this",
	    "<TestDialogueBox>.Speaker ~ (Tests.Suzunoya.Reimu, DontClearText)",
