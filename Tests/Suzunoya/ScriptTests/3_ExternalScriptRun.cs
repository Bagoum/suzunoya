...
public class _3ExternalScriptRunExample {
    ...
    private static readonly string[] stored = {
	    ...
	    "<TestDialogueBox>.Dialogue ~ (TagOpen { name = color, tag = Color { RequiresRender = True, color = red } }, hello)",
	    ...
	    "<TestDialogueBox>.Dialogue ~ (TagOpen { name = silent, tag = Silent { RequiresRender = False } }, rld)",
	    "<TestDialogueBox>.Dialogue ~ (Char { fragment = r }, ld)",
	    "<TestDialogueBox>.Dialogue ~ (Char { fragment = l }, d)",
	    "<TestDialogueBox>.Dialogue ~ (TagClose { opener = TagOpen { name = color, tag = Color { RequiresRender = True, color = red } } }, d)",
	    "<TestDialogueBox>.Dialogue ~ (Char { fragment = d }, )",
	    "<TestDialogueBox>.Dialogue ~ (TagClose { opener = TagOpen { name = silent, tag = Silent { RequiresRender = False } } }, )",
