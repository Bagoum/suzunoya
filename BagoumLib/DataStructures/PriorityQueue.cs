// COPIED FROM https://source.dot.net/#System.Collections/src/libraries/Common/src/System/Collections/Generic/EnumerableHelpers.cs
// WITH MINOR MODIFICATIONS TO SUPPORT NETSTANDARD2.1 AND LACK OF ACCESS TO INTERNAL CLASSES.
// WHY DID I COPY THIS FROM C# SOURCE? - BECAUSE PRIORITYQUEUE IS DOTNET6, WHICH ISN'T SUPPORTED IN UNITY.
    ...
    public class PriorityQueue<TElement, TPriority>
    {
        ...
        public sealed class UnorderedItemsCollection : IReadOnlyCollection<(TElement Element, TPriority Priority)>, ICollection
        {
            ...
            IEnumerator<(TElement Element, TPriority Priority)> IEnumerable<(TElement Element, TPriority Priority)>.GetEnumerator() =>
                _queue.Count == 0 ? ((IEnumerable<(TElement,TPriority)>)Array.Empty<(TElement Element, TPriority Priority)>()).GetEnumerator() :
                GetEnumerator();
